                ...
                <div className="hero bg-base-200 ">
                    <div className="hero-content flex-col w-full">
                        <div className="text-center lg:text-left">
                            <h1 className=" text-2xl md:text-5xl font-bold mb-10">To Start <span className='text-[#571414]'>Zeusing</span></h1>

                        </div>
                        <div className="card bg-base-100 md:w-full w-fit   shadow-2xl ">
                            <div className="card-body flex md:flex-row flex-col w-90 md:w-full lg:justify-between">
                                    ...
                                    <div className=''>
                                        <form onSubmit={handleSubmit}>
                                            <fieldset className="fieldset">
                                                ...
                                                <button className="btn bg-[#571414]  shadow-none text-white hover:bg-[#491011] w-80">Login</button>
                                ...
                                <div className='md:flex md:justify-center  md:w-full'>
                                    <div className='flex flex-col md:pt-15 w-50  '>
                                        <h1 className='text-2xl font-semibold mb-2 text-gray-500 w-79 md:w-full text-center '>Login With Social</h1>
                                        <button onClick={handleSignInGoogle} className="btn bg-white text-black border-[#e5e5e5] border-2 md:w-full w-79">
