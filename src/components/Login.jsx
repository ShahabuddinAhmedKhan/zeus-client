                    ...
                    <div className="hero-content flex-col ">
                        ...
                        <div className="card bg-base-100 md:w-full w-fit   shadow-2xl">
                            <div className="card-body flex md:flex-row flex-col w-fit md:w-full">
                                <div className='flex-grow'>
                                    <form onSubmit={handleSubmit}>
                                        <fieldset className="fieldset">
                                            ...
                                            <button className="btn bg-[#571414] border-0 shadow-none text-white hover:bg-[#491011] w-full">Login</button>
                                ...
                                <div className='flex flex-col md:pt-15 w-50 items-center'>
